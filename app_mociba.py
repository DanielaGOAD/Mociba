...
def cargar_datos_base():
    ...
    for file_id in file_ids:
        try:
            ...
            # PASO 1: Leer solo encabezados para saber qué columnas existen
            ...
            if columnas_faltantes:
                df_faltantes = pd.DataFrame(
                    np.nan,  # ✅ Usar np.nan en lugar de pd.NA
                    index=df_temp.index,
            ...
            # PASO 6: ✅ Convertir TODAS las columnas de preguntas a float64 AHORA
    ...
    # Rellenar NOM_ENT faltante usando .loc (sin columna temporal)
    ...
    # ✅ Desfragmentar el DataFrame UNA SOLA VEZ al final
    ...
    for anio_grupo, grupo in df_filtrado.groupby("ANIO"):
        try:
            if tipo_calculo == "simple":
                ...
                # ✅ OPTIMIZACIÓN: Usar numpy directamente (100x más rápido)
...
if tipo_variable == "Ciberacoso por nivel de escolaridad":
    ...
    if estado_1 != estado_2:
        ...
        if resultado_1.empty and resultado_2.empty:
            ...
            st.bar_chart(df_grafico, x="Rango de Edad", y="Porcentaje", color="Entidad", x_label="Edad del Agresor", y_label="Porcentaje de Víctimas (%)")
    ...
    if estado_1 != estado_2:
        ...
        if resultado_1.empty and resultado_2.empty:
            ...
            df_grafico = pd.DataFrame(grafico_data)
            st.bar_chart(df_grafico, x="Efecto", y="Porcentaje", color="Entidad", x_label="Efecto", y_label="Porcentaje de Víctimas (%)")
